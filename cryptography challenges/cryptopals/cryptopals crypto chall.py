...
# in_bytes = bytes.fromhex(hex)
# in_base64 = base64.b64encode(in_bytes)
# print(in_base64)

#2)
# import base64
# hex1 = "1c0111001f010100061a024b53535009181c"
# hex1_dec = bytes.fromhex(hex1)
# hex2 = "686974207468652062756c6c277320657965"
# hex2_dec = bytes.fromhex(hex2)
# xor_ans = bytes([i^j for i,j in zip(hex1_dec,hex2_dec)])
# print(xor_ans.hex())
...
# for i in range(256):  
#     xored_bytes = bytes([byte ^ i for byte in byte_string])
#     print('\n',i)
#     print(xored_bytes)
...
#     encrypted_byte = ord(text[i]) ^ ord(key[i % key_length])
#     encrypted_hex += "{:02x}".format(encrypted_byte)
# print(encrypted_hex)

#7)
# import base64
# from Crypto.Cipher import AES
# bas64 = '''CRIwqt4+szDbqkNY+I0qbDe3LQz0wiw0SuxBQtAM5TDdMbjCMD/venUDW9BL
...
# bas64_dec = base64.b64decode(bas64)
# cipher = AES.new(key, AES.MODE_ECB)
# dec_data = cipher.decrypt(bas64_dec)
